...
//   }),
  QuizModel("Which program runs first after booting the computer and loading the GUI?",
      {
...
//     "98": false,
//   }),
  QuizModel("Which of the following operating systems do you use for a client-server network?",
      {
        "MAC": false,
        "Windows  2000": true,
        "Linux": false,
