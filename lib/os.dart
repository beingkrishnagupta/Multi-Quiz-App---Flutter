        ...
        child: Scaffold(
          ...
          body: Padding(
              ...
              child: PageView.builder(
                  ...
                  itemBuilder: (context, index)  { // Adds an item to the list. Constructs the item list defined by this builder. Sets the text to display if the list is empty
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        const Divider( //adds a line
                          color: Colors.white,
                          height: 12.0,
                          thickness: 1.0,
                        ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            questions[index].question!, //Appending ! to any variable tells the compiler that the variable is not null, and can be used safely
                            style: const TextStyle(
                          ...
                          Container(
                            ...
                            child: MaterialButton(
                              ...
                              color: isPressed
                                  ...
                                  .toList()[i] //Creates a List<T> and adds all elements of this stream to the list in the order they arrive
                                  .value
                                  ? isTrue
                                  : isFalse
                                  : secondColor,
