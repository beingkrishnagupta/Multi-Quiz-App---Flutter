...
import 'package:quiz_app/quizlist7.dart';
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Text(
                            "       Question ${index + 1} out of ${questions7.length}                                           MM: 50",
                        ...
                        for (int i = 0;
                        i < questions7[index].answers!.length;
                        i++)
                          Container(
                            width: 500.0,
                            ...
                            child: MaterialButton(
                              ...
                              child: Text(
                                questions7[index].answers!.keys.toList()[i],
                                style: TextStyle(
